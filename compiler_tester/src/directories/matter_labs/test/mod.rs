...
impl Buildable for MatterLabsTest {
    fn build_for_eravm(
        ...
        let evm_address_iterator = EVMAddressIterator::new(matches!(target, Target::EVM));
    ...
    fn build_for_evm(
        ...
        let mut evm_address_iterator = EVMAddressIterator::new(matches!(target, Target::EVM));
